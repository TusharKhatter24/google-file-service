...
export const employees = [
  {
    ...
    skills: ['Knowledgeable', 'Fast', 'Multilingual', 'Domain Expert'],
    capabilities: [
  ...
  },
  {
    ...
    skills: ['Creative', 'Analytical', 'Fast', 'Domain Expert'],
    capabilities: [
  ...
  },
  {
    ...
    skills: ['Technical', 'Analytical', 'Fast', 'Domain Expert'],
    capabilities: [
  ...
  },
  {
    ...
    department: 'Sales',
    personality: 'Friendly',
    skills: ['Friendly', 'Knowledgeable', 'Fast', 'Domain Expert'],
    capabilities: [
      'Customer onboarding guidance',
      'Welcome experience creation',
      'Product and service education',
      'Resource and documentation provision'
    ],
  ...
  },
  {
    ...
    department: 'IT',
    personality: 'Analytical',
    skills: ['Analytical', 'Fast', 'Technical', 'Domain Expert'],
    capabilities: [
