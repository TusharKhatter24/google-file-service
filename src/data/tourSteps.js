...
export const employeeSelectionTour = [
  {
    ...
    description: 'Click on any employee card to open their detail page and start working with them. Each employee has unique capabilities.',
    position: 'top'
  },
  {
    target: '[data-tour-target="create-card"]',
    title: 'Create Custom Employee',
    description: 'Build your own custom AI employee tailored to your specific needs. Click here to create a new employee with custom settings.',
    position: 'top'
  },
  {
    target: '.org-settings-button',
    title: 'Organization Settings',
    description: 'Configure organization-wide settings and preferences that apply to all employees in your workspace.',
    position: 'bottom'
  }
];
